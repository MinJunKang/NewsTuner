              ...
              {level.id === "paste" ? (
                <div className="paste">
                  ...
                  <details className="howto">
                    ...
                    <p className="howto__h">아이폰 — 사파리·크롬 공통</p>
                    <p>
                      한 번만 만들어 두면 그다음부터는 탭 두 번입니다. 단축어 앱에서 새 단축어를
                      만들고 액션 세 개를 순서대로 넣으세요.
                    </p>
                    <ol>
                    ...
                    <p>
                      그다음 단축어 정보에서 <b>공유 시트에 표시</b>를 켭니다. 이제 기사에서 공유
                      버튼을 누르고 이 단축어를 고르면 본문만 클립보드에 담기고, 여기서 아래
                      버튼만 누르면 됩니다. 액션 이름은 iOS 버전마다 조금 다를 수 있습니다.
                    </p>

                    <p className="howto__h">단축어 없이 할 때</p>
                    <ul>
                      <li>
                        <b>사파리</b> — 주소창 왼쪽 <b>aA</b> → 읽기 도구 표시. 본문만 남아서 길게
                        눌러 전체 선택하기가 훨씬 쉽습니다.
                      </li>
                      <li>
                        <b>아이폰 크롬</b> — 공유 버튼을 누르면 아이폰 공유 시트가 그대로 열리므로
                        위 단축어를 똑같이 쓸 수 있습니다.
                      </li>
                      <li>
                        <b>컴퓨터</b> — 기사 본문을 클릭하고 Ctrl+A(맥은 ⌘+A) 후 복사.
                      </li>
                    </ul>
                  </details>
                  <textarea
