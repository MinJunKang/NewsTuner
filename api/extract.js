...
export function extractArticle(html) {
  ...
  const TAIL = /moderates comments|all rights reserved|sign up for|originally (appeared|published)|newsletter|delivered to your (e-?mail |in)?box|get highlights of|recommended citation|isn't possible without your support|journalism changes lives|already a subscriber|subscribe to continue/i;
